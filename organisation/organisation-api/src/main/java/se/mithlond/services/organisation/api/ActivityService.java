...
public interface ActivityService {
	 ...
	 *
	 * @param startPeriod      The DateTime marking the start of the period for the activities to return.
	 *                         All returned Activities will be after this DateTime (inclusive).
	 * @param endPeriod        The DateTime marking the end of the period for the activities to return.
	 *                         All returned Activities will be before this DateTime (inclusive).
	 * @param organisationName The name of the organisation owning the Activities.
	 * @return all Activities within the supplied organisationName within the supplied Period.
	 */
	List<Activity> getActivities(ZonedDateTime startPeriod, ZonedDateTime endPeriod, String organisationName);
