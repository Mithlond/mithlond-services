 ...
 */
/**
 * Package containing <em>convenience</em> transport classes for entities (meaning that the transport classes are not
 * unmarshallable using JAXB). These transport classes are only JAXB-annotated and resides within a separate Namespace.
 *
...
package se.mithlond.services.organisation.model.transport.convenience;
