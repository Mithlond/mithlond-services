...
public class AllergySeverity extends NazgulEntity implements Comparable<AllergySeverity> {
     ...
     * <p>
     * /**
     * Minor allergy. While the substance causes discomfort for the Member, it can occur in
     * food and be managed by the Member him/herself (such as not eating carrots, placed
     * on the served dish).
     * MINOR,
     * <p>
     * /**
     * Major allergy. This substance cannot occur in the food of the Member for any reason.
     * The Member may need medication to handle the conditions arising from this severity.
     * CANNOT_BE_INGESTED,
     * <p>
     * /**
     * Fatal allergy. The substance cannot occur in the same room as the Member, for risk of medical conditions.
