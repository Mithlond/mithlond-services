 ...
 */
public class T_AbstractPlainJaxbTestTest extends AbstractPlainJaxbTest {
    ...
    public void validateMarshalling() throws Exception {
        ...
        // Assemble
        final String expected = XmlTestUtils.readFully("testdata/barRound.xml");
    ...
    public void validateUnmarshalling() throws Exception {
        ...
        // Assemble
        final String data = XmlTestUtils.readFully("testdata/barRound.xml");
