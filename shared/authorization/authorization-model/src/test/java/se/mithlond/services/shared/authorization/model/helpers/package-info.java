 ...
 */
/**
 * Package holding entity classes defining Authentication entities in the context of the Mithlond reactor.
 *
 * @author <a href="mailto:lj@jguru.se">Lennart J&ouml;relid</a>, jGuru Europe AB
 */
@XmlSchema(
        xmlns = {
                @XmlNs(prefix = "authorization", namespaceURI = Patterns.NAMESPACE),
